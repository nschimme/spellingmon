<template>
  ...
  >
    ...
    <div class="absolute top-10 left-10 text-6xl opacity-20 animate-bounce" aria-hidden="true">
      🔥
    </div>
    <div class="absolute bottom-20 right-20 text-6xl opacity-20 animate-pulse" aria-hidden="true">
      💧
    </div>
    <div class="absolute top-1/2 left-20 text-6xl opacity-20 animate-bounce delay-700" aria-hidden="true">
      🌿
    </div>
    ...
    <div class="z-10 flex flex-col items-center max-w-lg w-full">
      <div class="bg-white border-8 border-gray-800 p-4 md:p-12 rounded-[3rem] shadow-2xl transform -rotate-2 hover:rotate-0 transition-transform duration-500 w-full">
        <h1 id="landing-title" class="text-xl leading-none md:text-4xl font-black text-center mb-4 uppercase tracking-tight text-orange-500 drop-shadow-[4px_4px_0_rgba(0,0,0,1)]">
          {{ $t('landing.title') }}
        </h1>
      ...
      <p class="mt-8 md:mt-12 text-white/50 font-bold uppercase text-[10px] tracking-widest animate-pulse" aria-live="polite">
