import { MONSTER_TYPES, BIOMES, MOVE_IDS, MOVE_CATEGORIES, STATUS_CONDITIONS, MOVE_EFFECT_TYPES, STAT_KEYS } from './constants';
...
export const MOVES: Record<string, Move> = {
  ...
  [MOVE_IDS.Acid]: { id: MOVE_IDS.Acid, name: "Acid", type: MONSTER_TYPES.POISON, category: MOVE_CATEGORIES.SPECIAL, power: 40, accuracy: 100, effectType: MOVE_EFFECT_TYPES.STAT_DOWN, effectStat: STAT_KEYS.DEF, effectAmount: 1 },
  [MOVE_IDS.AcidArmor]: { id: MOVE_IDS.AcidArmor, name: "AcidArmor", type: MONSTER_TYPES.POISON, category: MOVE_CATEGORIES.STATUS, power: 0, accuracy: 100, effectType: MOVE_EFFECT_TYPES.STAT_UP, effectStat: STAT_KEYS.DEF, effectAmount: 2 },
  [MOVE_IDS.Agility]: { id: MOVE_IDS.Agility, name: "Agility", type: MONSTER_TYPES.PSYCHIC, category: MOVE_CATEGORIES.STATUS, power: 0, accuracy: 100, effectType: MOVE_EFFECT_TYPES.STAT_UP, effectStat: STAT_KEYS.SPE, effectAmount: 2 },
  [MOVE_IDS.Amnesia]: { id: MOVE_IDS.Amnesia, name: "Amnesia", type: MONSTER_TYPES.PSYCHIC, category: MOVE_CATEGORIES.STATUS, power: 0, accuracy: 100, effectType: MOVE_EFFECT_TYPES.STAT_UP, effectStat: STAT_KEYS.DEF, effectAmount: 2 },
  [MOVE_IDS.AuroraBeam]: { id: MOVE_IDS.AuroraBeam, name: "AuroraBeam", type: MONSTER_TYPES.ICE, category: MOVE_CATEGORIES.SPECIAL, power: 65, accuracy: 100, effectType: MOVE_EFFECT_TYPES.STAT_DOWN, effectStat: STAT_KEYS.ATK, effectAmount: 1 },
  ...
  [MOVE_IDS.Barrier]: { id: MOVE_IDS.Barrier, name: "Barrier", type: MONSTER_TYPES.PSYCHIC, category: MOVE_CATEGORIES.STATUS, power: 0, accuracy: 100, effectType: MOVE_EFFECT_TYPES.STAT_UP, effectStat: STAT_KEYS.DEF, effectAmount: 2 },
  ...
  [MOVE_IDS.Blizzard]: { id: MOVE_IDS.Blizzard, name: "Blizzard", type: MONSTER_TYPES.ICE, category: MOVE_CATEGORIES.SPECIAL, power: 110, accuracy: 70, effectType: MOVE_EFFECT_TYPES.STATUS, effectStat: STATUS_CONDITIONS.FREEZE },
  [MOVE_IDS.BodySlam]: { id: MOVE_IDS.BodySlam, name: "BodySlam", type: MONSTER_TYPES.NORMAL, category: MOVE_CATEGORIES.PHYSICAL, power: 85, accuracy: 100, effectType: MOVE_EFFECT_TYPES.STATUS, effectStat: STATUS_CONDITIONS.PARALYSIS },
  ...
  [MOVE_IDS.Bubble]: { id: MOVE_IDS.Bubble, name: "Bubble", type: MONSTER_TYPES.WATER, category: MOVE_CATEGORIES.SPECIAL, power: 40, accuracy: 100, effectType: MOVE_EFFECT_TYPES.STAT_DOWN, effectStat: STAT_KEYS.SPE, effectAmount: 1 },
  [MOVE_IDS.BubbleBeam]: { id: MOVE_IDS.BubbleBeam, name: "BubbleBeam", type: MONSTER_TYPES.WATER, category: MOVE_CATEGORIES.SPECIAL, power: 65, accuracy: 100, effectType: MOVE_EFFECT_TYPES.STAT_DOWN, effectStat: STAT_KEYS.SPE, effectAmount: 1 },
  ...
  [MOVE_IDS.ConfuseRay]: { id: MOVE_IDS.ConfuseRay, name: "ConfuseRay", type: MONSTER_TYPES.GHOST, category: MOVE_CATEGORIES.STATUS, power: 0, accuracy: 100, effectType: MOVE_EFFECT_TYPES.STATUS, effectStat: STATUS_CONDITIONS.CONFUSION },
  [MOVE_IDS.Confusion]: { id: MOVE_IDS.Confusion, name: "Confusion", type: MONSTER_TYPES.PSYCHIC, category: MOVE_CATEGORIES.SPECIAL, power: 50, accuracy: 100, effectType: MOVE_EFFECT_TYPES.STATUS, effectStat: STATUS_CONDITIONS.CONFUSION },
  [MOVE_IDS.Constrict]: { id: MOVE_IDS.Constrict, name: "Constrict", type: MONSTER_TYPES.NORMAL, category: MOVE_CATEGORIES.PHYSICAL, power: 10, accuracy: 100, effectType: MOVE_EFFECT_TYPES.STAT_DOWN, effectStat: STAT_KEYS.SPE, effectAmount: 1 },
  ...
  [MOVE_IDS.DefenseCurl]: { id: MOVE_IDS.DefenseCurl, name: "DefenseCurl", type: MONSTER_TYPES.NORMAL, category: MOVE_CATEGORIES.STATUS, power: 0, accuracy: 100, effectType: MOVE_EFFECT_TYPES.STAT_UP, effectStat: STAT_KEYS.DEF, effectAmount: 1 },
  ...
  [MOVE_IDS.DizzyPunch]: { id: MOVE_IDS.DizzyPunch, name: "DizzyPunch", type: MONSTER_TYPES.NORMAL, category: MOVE_CATEGORIES.PHYSICAL, power: 70, accuracy: 100, effectType: MOVE_EFFECT_TYPES.STATUS, effectStat: STATUS_CONDITIONS.CONFUSION },
  ...
  [MOVE_IDS.DoubleTeam]: { id: MOVE_IDS.DoubleTeam, name: "DoubleTeam", type: MONSTER_TYPES.NORMAL, category: MOVE_CATEGORIES.STATUS, power: 0, accuracy: 100, effectType: MOVE_EFFECT_TYPES.STAT_UP, effectStat: STAT_KEYS.EVA, effectAmount: 1 },
  ...
  [MOVE_IDS.DreamEater]: { id: MOVE_IDS.DreamEater, name: "DreamEater", type: MONSTER_TYPES.PSYCHIC, category: MOVE_CATEGORIES.SPECIAL, power: 100, accuracy: 100, effectType: MOVE_EFFECT_TYPES.DRAIN, effectStat: STATUS_CONDITIONS.SLEEP },
  ...
  [MOVE_IDS.Ember]: { id: MOVE_IDS.Ember, name: "Ember", type: MONSTER_TYPES.FIRE, category: MOVE_CATEGORIES.SPECIAL, power: 40, accuracy: 100, effectType: MOVE_EFFECT_TYPES.STATUS, effectStat: STATUS_CONDITIONS.BURN },
  ...
  [MOVE_IDS.FireBlast]: { id: MOVE_IDS.FireBlast, name: "FireBlast", type: MONSTER_TYPES.FIRE, category: MOVE_CATEGORIES.SPECIAL, power: 110, accuracy: 85, effectType: MOVE_EFFECT_TYPES.STATUS, effectStat: STATUS_CONDITIONS.BURN },
  [MOVE_IDS.FirePunch]: { id: MOVE_IDS.FirePunch, name: "FirePunch", type: MONSTER_TYPES.FIRE, category: MOVE_CATEGORIES.PHYSICAL, power: 75, accuracy: 100, effectType: MOVE_EFFECT_TYPES.STATUS, effectStat: STATUS_CONDITIONS.BURN },
  ...
  [MOVE_IDS.Flamethrower]: { id: MOVE_IDS.Flamethrower, name: "Flamethrower", type: MONSTER_TYPES.FIRE, category: MOVE_CATEGORIES.SPECIAL, power: 90, accuracy: 100, effectType: MOVE_EFFECT_TYPES.STATUS, effectStat: STATUS_CONDITIONS.BURN },
  [MOVE_IDS.Flash]: { id: MOVE_IDS.Flash, name: "Flash", type: MONSTER_TYPES.NORMAL, category: MOVE_CATEGORIES.STATUS, power: 0, accuracy: 100, effectType: MOVE_EFFECT_TYPES.STAT_DOWN, effectStat: STAT_KEYS.ACC, effectAmount: 1 },
  ...
  [MOVE_IDS.Glare]: { id: MOVE_IDS.Glare, name: "Glare", type: MONSTER_TYPES.NORMAL, category: MOVE_CATEGORIES.STATUS, power: 0, accuracy: 100, effectType: MOVE_EFFECT_TYPES.STATUS, effectStat: STATUS_CONDITIONS.PARALYSIS },
  [MOVE_IDS.Growl]: { id: MOVE_IDS.Growl, name: "Growl", type: MONSTER_TYPES.NORMAL, category: MOVE_CATEGORIES.STATUS, power: 0, accuracy: 100, effectType: MOVE_EFFECT_TYPES.STAT_DOWN, effectStat: STAT_KEYS.ATK, effectAmount: 1 },
  [MOVE_IDS.Growth]: { id: MOVE_IDS.Growth, name: "Growth", type: MONSTER_TYPES.NORMAL, category: MOVE_CATEGORIES.STATUS, power: 0, accuracy: 100, effectType: MOVE_EFFECT_TYPES.STAT_UP, effectStat: STAT_KEYS.ATK, effectAmount: 1 },
  ...
  [MOVE_IDS.Harden]: { id: MOVE_IDS.Harden, name: "Harden", type: MONSTER_TYPES.NORMAL, category: MOVE_CATEGORIES.STATUS, power: 0, accuracy: 100, effectType: MOVE_EFFECT_TYPES.STAT_UP, effectStat: STAT_KEYS.DEF, effectAmount: 1 },
  ...
  [MOVE_IDS.Hypnosis]: { id: MOVE_IDS.Hypnosis, name: "Hypnosis", type: MONSTER_TYPES.PSYCHIC, category: MOVE_CATEGORIES.STATUS, power: 0, accuracy: 60, effectType: MOVE_EFFECT_TYPES.STATUS, effectStat: STATUS_CONDITIONS.SLEEP },
  [MOVE_IDS.IceBeam]: { id: MOVE_IDS.IceBeam, name: "IceBeam", type: MONSTER_TYPES.ICE, category: MOVE_CATEGORIES.SPECIAL, power: 90, accuracy: 100, effectType: MOVE_EFFECT_TYPES.STATUS, effectStat: STATUS_CONDITIONS.FREEZE },
  [MOVE_IDS.IcePunch]: { id: MOVE_IDS.IcePunch, name: "IcePunch", type: MONSTER_TYPES.ICE, category: MOVE_CATEGORIES.PHYSICAL, power: 75, accuracy: 100, effectType: MOVE_EFFECT_TYPES.STATUS, effectStat: STATUS_CONDITIONS.FREEZE },
  ...
  [MOVE_IDS.Kinesis]: { id: MOVE_IDS.Kinesis, name: "Kinesis", type: MONSTER_TYPES.PSYCHIC, category: MOVE_CATEGORIES.STATUS, power: 0, accuracy: 80, effectType: MOVE_EFFECT_TYPES.STAT_DOWN, effectStat: STAT_KEYS.ACC, effectAmount: 1 },
  ...
  [MOVE_IDS.Leer]: { id: MOVE_IDS.Leer, name: "Leer", type: MONSTER_TYPES.NORMAL, category: MOVE_CATEGORIES.STATUS, power: 0, accuracy: 100, effectType: MOVE_EFFECT_TYPES.STAT_DOWN, effectStat: STAT_KEYS.DEF, effectAmount: 1 },
  [MOVE_IDS.Lick]: { id: MOVE_IDS.Lick, name: "Lick", type: MONSTER_TYPES.GHOST, category: MOVE_CATEGORIES.PHYSICAL, power: 30, accuracy: 100, effectType: MOVE_EFFECT_TYPES.STATUS, effectStat: STATUS_CONDITIONS.PARALYSIS },
  ...
  [MOVE_IDS.LovelyKiss]: { id: MOVE_IDS.LovelyKiss, name: "LovelyKiss", type: MONSTER_TYPES.NORMAL, category: MOVE_CATEGORIES.STATUS, power: 0, accuracy: 75, effectType: MOVE_EFFECT_TYPES.STATUS, effectStat: STATUS_CONDITIONS.SLEEP },
  ...
  [MOVE_IDS.Meditate]: { id: MOVE_IDS.Meditate, name: "Meditate", type: MONSTER_TYPES.PSYCHIC, category: MOVE_CATEGORIES.STATUS, power: 0, accuracy: 100, effectType: MOVE_EFFECT_TYPES.STAT_UP, effectStat: STAT_KEYS.ATK, effectAmount: 1 },
  ...
  [MOVE_IDS.Minimize]: { id: MOVE_IDS.Minimize, name: "Minimize", type: MONSTER_TYPES.NORMAL, category: MOVE_CATEGORIES.STATUS, power: 0, accuracy: 100, effectType: MOVE_EFFECT_TYPES.STAT_UP, effectStat: STAT_KEYS.EVA, effectAmount: 2 },
  ...
  [MOVE_IDS.PetalDance]: { id: MOVE_IDS.PetalDance, name: "PetalDance", type: MONSTER_TYPES.GRASS, category: MOVE_CATEGORIES.SPECIAL, power: 120, accuracy: 100, effectType: MOVE_EFFECT_TYPES.STATUS, effectStat: STATUS_CONDITIONS.CONFUSION },
  ...
  [MOVE_IDS.PoisonGas]: { id: MOVE_IDS.PoisonGas, name: "PoisonGas", type: MONSTER_TYPES.POISON, category: MOVE_CATEGORIES.STATUS, power: 0, accuracy: 90, effectType: MOVE_EFFECT_TYPES.STATUS, effectStat: STATUS_CONDITIONS.POISON },
  [MOVE_IDS.PoisonPowder]: { id: MOVE_IDS.PoisonPowder, name: "PoisonPowder", type: MONSTER_TYPES.POISON, category: MOVE_CATEGORIES.STATUS, power: 0, accuracy: 75, effectType: MOVE_EFFECT_TYPES.STATUS, effectStat: STATUS_CONDITIONS.POISON },
  [MOVE_IDS.PoisonSting]: { id: MOVE_IDS.PoisonSting, name: "PoisonSting", type: MONSTER_TYPES.POISON, category: MOVE_CATEGORIES.PHYSICAL, power: 15, accuracy: 100, effectType: MOVE_EFFECT_TYPES.STATUS, effectStat: STATUS_CONDITIONS.POISON },
  ...
  [MOVE_IDS.PsychicBeam]: { id: MOVE_IDS.PsychicBeam, name: "PsychicBeam", type: MONSTER_TYPES.PSYCHIC, category: MOVE_CATEGORIES.SPECIAL, power: 65, accuracy: 100, effectType: MOVE_EFFECT_TYPES.STATUS, effectStat: STATUS_CONDITIONS.CONFUSION },
  [MOVE_IDS.Psychic]: { id: MOVE_IDS.Psychic, name: "Psychic", type: MONSTER_TYPES.PSYCHIC, category: MOVE_CATEGORIES.SPECIAL, power: 90, accuracy: 100, effectType: MOVE_EFFECT_TYPES.STAT_DOWN, effectStat: STAT_KEYS.DEF, effectAmount: 1 },
  ...
  [MOVE_IDS.Rage]: { id: MOVE_IDS.Rage, name: "Rage", type: MONSTER_TYPES.NORMAL, category: MOVE_CATEGORIES.PHYSICAL, power: 20, accuracy: 100, effectType: MOVE_EFFECT_TYPES.STAT_UP, effectStat: STAT_KEYS.ATK, effectAmount: 1 },
  ...
  [MOVE_IDS.Rest]: { id: MOVE_IDS.Rest, name: "Rest", type: MONSTER_TYPES.PSYCHIC, category: MOVE_CATEGORIES.STATUS, power: 0, accuracy: 100, effectType: MOVE_EFFECT_TYPES.STATUS, effectStat: STATUS_CONDITIONS.SLEEP },
  ...
  [MOVE_IDS.SandAttack]: { id: MOVE_IDS.SandAttack, name: "SandAttack", type: MONSTER_TYPES.GROUND, category: MOVE_CATEGORIES.STATUS, power: 0, accuracy: 100, effectType: MOVE_EFFECT_TYPES.STAT_DOWN, effectStat: STAT_KEYS.ACC, effectAmount: 1 },
  ...
  [MOVE_IDS.Screech]: { id: MOVE_IDS.Screech, name: "Screech", type: MONSTER_TYPES.NORMAL, category: MOVE_CATEGORIES.STATUS, power: 0, accuracy: 85, effectType: MOVE_EFFECT_TYPES.STAT_DOWN, effectStat: STAT_KEYS.DEF, effectAmount: 2 },
  ...
  [MOVE_IDS.Sharpen]: { id: MOVE_IDS.Sharpen, name: "Sharpen", type: MONSTER_TYPES.NORMAL, category: MOVE_CATEGORIES.STATUS, power: 0, accuracy: 100, effectType: MOVE_EFFECT_TYPES.STAT_UP, effectStat: STAT_KEYS.ATK, effectAmount: 1 },
  [MOVE_IDS.Sing]: { id: MOVE_IDS.Sing, name: "Sing", type: MONSTER_TYPES.NORMAL, category: MOVE_CATEGORIES.STATUS, power: 0, accuracy: 55, effectType: MOVE_EFFECT_TYPES.STATUS, effectStat: STATUS_CONDITIONS.SLEEP },
  [MOVE_IDS.SkullBash]: { id: MOVE_IDS.SkullBash, name: "SkullBash", type: MONSTER_TYPES.NORMAL, category: MOVE_CATEGORIES.PHYSICAL, power: 130, accuracy: 100, effectType: MOVE_EFFECT_TYPES.STAT_UP, effectStat: STAT_KEYS.ATK, effectAmount: 1 },
  ...
  [MOVE_IDS.SleepPowder]: { id: MOVE_IDS.SleepPowder, name: "SleepPowder", type: MONSTER_TYPES.GRASS, category: MOVE_CATEGORIES.STATUS, power: 0, accuracy: 75, effectType: MOVE_EFFECT_TYPES.STATUS, effectStat: STATUS_CONDITIONS.SLEEP },
  [MOVE_IDS.Sludge]: { id: MOVE_IDS.Sludge, name: "Sludge", type: MONSTER_TYPES.POISON, category: MOVE_CATEGORIES.SPECIAL, power: 65, accuracy: 100, effectType: MOVE_EFFECT_TYPES.STATUS, effectStat: STATUS_CONDITIONS.POISON },
  [MOVE_IDS.Smog]: { id: MOVE_IDS.Smog, name: "Smog", type: MONSTER_TYPES.POISON, category: MOVE_CATEGORIES.SPECIAL, power: 30, accuracy: 70, effectType: MOVE_EFFECT_TYPES.STATUS, effectStat: STATUS_CONDITIONS.POISON },
  [MOVE_IDS.Smokescreen]: { id: MOVE_IDS.Smokescreen, name: "Smokescreen", type: MONSTER_TYPES.NORMAL, category: MOVE_CATEGORIES.STATUS, power: 0, accuracy: 100, effectType: MOVE_EFFECT_TYPES.STAT_DOWN, effectStat: STAT_KEYS.ACC, effectAmount: 1 },
  ...
  [MOVE_IDS.Spore]: { id: MOVE_IDS.Spore, name: "Spore", type: MONSTER_TYPES.GRASS, category: MOVE_CATEGORIES.STATUS, power: 0, accuracy: 100, effectType: MOVE_EFFECT_TYPES.STATUS, effectStat: STATUS_CONDITIONS.SLEEP },
  ...
  [MOVE_IDS.StringShot]: { id: MOVE_IDS.StringShot, name: "StringShot", type: MONSTER_TYPES.BUG, category: MOVE_CATEGORIES.STATUS, power: 0, accuracy: 95, effectType: MOVE_EFFECT_TYPES.STAT_DOWN, effectStat: STAT_KEYS.SPE, effectAmount: 2 },
  ...
  [MOVE_IDS.StunSpore]: { id: MOVE_IDS.StunSpore, name: "StunSpore", type: MONSTER_TYPES.GRASS, category: MOVE_CATEGORIES.STATUS, power: 0, accuracy: 75, effectType: MOVE_EFFECT_TYPES.STATUS, effectStat: STATUS_CONDITIONS.PARALYSIS },
  ...
  [MOVE_IDS.Supersonic]: { id: MOVE_IDS.Supersonic, name: "Supersonic", type: MONSTER_TYPES.NORMAL, category: MOVE_CATEGORIES.STATUS, power: 0, accuracy: 55, effectType: MOVE_EFFECT_TYPES.STATUS, effectStat: STATUS_CONDITIONS.CONFUSION },
  ...
  [MOVE_IDS.SwordsDance]: { id: MOVE_IDS.SwordsDance, name: "SwordsDance", type: MONSTER_TYPES.NORMAL, category: MOVE_CATEGORIES.STATUS, power: 0, accuracy: 100, effectType: MOVE_EFFECT_TYPES.STAT_UP, effectStat: STAT_KEYS.ATK, effectAmount: 2 },
  [MOVE_IDS.TailWhip]: { id: MOVE_IDS.TailWhip, name: "TailWhip", type: MONSTER_TYPES.NORMAL, category: MOVE_CATEGORIES.STATUS, power: 0, accuracy: 100, effectType: MOVE_EFFECT_TYPES.STAT_DOWN, effectStat: STAT_KEYS.DEF, effectAmount: 1 },
  ...
  [MOVE_IDS.Thrash]: { id: MOVE_IDS.Thrash, name: "Thrash", type: MONSTER_TYPES.NORMAL, category: MOVE_CATEGORIES.PHYSICAL, power: 120, accuracy: 100, effectType: MOVE_EFFECT_TYPES.STATUS, effectStat: STATUS_CONDITIONS.CONFUSION },
  [MOVE_IDS.Thunder]: { id: MOVE_IDS.Thunder, name: "Thunder", type: MONSTER_TYPES.ELECTRIC, category: MOVE_CATEGORIES.SPECIAL, power: 110, accuracy: 70, effectType: MOVE_EFFECT_TYPES.STATUS, effectStat: STATUS_CONDITIONS.PARALYSIS },
  [MOVE_IDS.ThunderPunch]: { id: MOVE_IDS.ThunderPunch, name: "ThunderPunch", type: MONSTER_TYPES.ELECTRIC, category: MOVE_CATEGORIES.PHYSICAL, power: 75, accuracy: 100, effectType: MOVE_EFFECT_TYPES.STATUS, effectStat: STATUS_CONDITIONS.PARALYSIS },
  [MOVE_IDS.ThunderShock]: { id: MOVE_IDS.ThunderShock, name: "ThunderShock", type: MONSTER_TYPES.ELECTRIC, category: MOVE_CATEGORIES.SPECIAL, power: 40, accuracy: 100, effectType: MOVE_EFFECT_TYPES.STATUS, effectStat: STATUS_CONDITIONS.PARALYSIS },
  [MOVE_IDS.ThunderWave]: { id: MOVE_IDS.ThunderWave, name: "ThunderWave", type: MONSTER_TYPES.ELECTRIC, category: MOVE_CATEGORIES.STATUS, power: 0, accuracy: 90, effectType: MOVE_EFFECT_TYPES.STATUS, effectStat: STATUS_CONDITIONS.PARALYSIS },
  [MOVE_IDS.Thunderbolt]: { id: MOVE_IDS.Thunderbolt, name: "Thunderbolt", type: MONSTER_TYPES.ELECTRIC, category: MOVE_CATEGORIES.SPECIAL, power: 90, accuracy: 100, effectType: MOVE_EFFECT_TYPES.STATUS, effectStat: STATUS_CONDITIONS.PARALYSIS },
  [MOVE_IDS.Toxic]: { id: MOVE_IDS.Toxic, name: "Toxic", type: MONSTER_TYPES.POISON, category: MOVE_CATEGORIES.STATUS, power: 0, accuracy: 90, effectType: MOVE_EFFECT_TYPES.STATUS, effectStat: STATUS_CONDITIONS.POISON },
  ...
  [MOVE_IDS.TriAttack]: { id: MOVE_IDS.TriAttack, name: "TriAttack", type: MONSTER_TYPES.NORMAL, category: MOVE_CATEGORIES.SPECIAL, power: 80, accuracy: 100, effectType: MOVE_EFFECT_TYPES.STATUS, effectStat: STATUS_CONDITIONS.FREEZE },
  [MOVE_IDS.TwinNeedle]: { id: MOVE_IDS.TwinNeedle, name: "TwinNeedle", type: MONSTER_TYPES.BUG, category: MOVE_CATEGORIES.PHYSICAL, power: 25, accuracy: 100, effectType: MOVE_EFFECT_TYPES.STATUS, effectStat: STATUS_CONDITIONS.POISON },
  ...
  [MOVE_IDS.Withdraw]: { id: MOVE_IDS.Withdraw, name: "Withdraw", type: MONSTER_TYPES.WATER, category: MOVE_CATEGORIES.STATUS, power: 0, accuracy: 100, effectType: MOVE_EFFECT_TYPES.STAT_UP, effectStat: STAT_KEYS.DEF, effectAmount: 1 }
};
