...
export const MONS: Record<string, SpeciesBase> = {
  ...
  [SPECIES.Copybone]: { types: [MONSTER_TYPES.GROUND], emoji: 'BONE', baseHp: 50, baseAtk: 50, baseDef: 95, baseSpa: 40, baseSpd: 50, baseSpe: 35, evolvesAt: 28, evolvesInto: SPECIES.Memowak, learnset: { 1: [MOVE_IDS.BoneClub, MOVE_IDS.Growl], 25: [MOVE_IDS.Leer], 31: [MOVE_IDS.FocusEnergy], 38: [MOVE_IDS.Thrash], 43: [MOVE_IDS.BoneBoomerang], 46: [MOVE_IDS.Rage] } },
  [SPECIES.Memowak]: { types: [MONSTER_TYPES.GROUND], emoji: 'BONE', baseHp: 60, baseAtk: 80, baseDef: 110, baseSpa: 50, baseSpd: 80, baseSpe: 45, learnset: { 1: [MOVE_IDS.BoneClub, MOVE_IDS.FocusEnergy, MOVE_IDS.Growl, MOVE_IDS.Leer], 25: [MOVE_IDS.Leer], 33: [MOVE_IDS.FocusEnergy], 41: [MOVE_IDS.Thrash], 48: [MOVE_IDS.BoneBoomerang], 55: [MOVE_IDS.Rage] } },
